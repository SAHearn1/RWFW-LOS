...
{`/  -> Start as Independent Learner
   ...
   -> /app/studio`}
      ...
      <section className="flex flex-wrap gap-3">
        ...
        <Link className="rounded border border-slate-300 bg-white px-4 py-2 text-sm font-medium text-slate-800" href="/sign-in?intent=teacher">
          Teacher Login
        </Link>
        <Link className="rounded border border-slate-300 bg-white px-4 py-2 text-sm font-medium text-slate-800" href="/sign-in?intent=admin">
          Admin Login
        </Link>
      </section>
    </main>
