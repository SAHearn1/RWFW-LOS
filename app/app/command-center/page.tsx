...
export default async function CommandCenterPage() {
  ...
  return (
    <section className="space-y-4" data-tour="command-center-page">
      ...
      <p className="text-sm text-slate-700" data-tour="page-description">
        Facilitate day-to-day operations across intervention queues, reviews, and cohort priorities.
      </p>
      <div className="rounded-lg border border-slate-200 bg-slate-50 p-4 text-sm text-slate-600">
        Command Center is now an owned route page with facilitator role protection.
      </div>
    </section>
  );
}
